...
var passwordCheckOld = function () 
{
   ...
   {
       stringOutput = "Password must be greater than eight characters.";
   }
   else
   {
     for (i=0; i < arrayBadPasswords.length; i++) 
   {
     if (stringPassword = arrayBadPasswords[i])
      {
         stringOutput = "Password must be changed. Please choose a different password.";
         break;
      }
   }
   }
   if (stringOutput != "Password must be changed. Please choose a different password." && stringOutput != "Password must be greater than eight characters.")
   {
